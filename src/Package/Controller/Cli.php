...
namespace Package\Difference\Fun\Boot\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} difference_fun/boot                    | boot options',
        '{{binary()}} difference_fun/boot setup              | boot setup',
        '{{binary()}} difference_fun/boot update             | boot update',
    ];
